...
const createCardComponent = ({ title, description, photo, price }: GiftTemplate) => {
...
export const renderGiftCards = (gifts: Gift[]) => {
...
export const renderNewGiftCard = (gift: GiftTemplate) => {
    const container = document.getElementById('gift-cards');
